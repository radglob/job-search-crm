...
class LegacyMetadata(object):
    ...
    def set(self, name, value):
        ...
        if (
            (name in _ELEMENTSFIELD or name == "Platform")
...
class Metadata(object):
    ...
    def __getattribute__(self, key):
        ...
        if key in mapped:
            ...
            if self._legacy:
                ...
                if key not in (
                    "commands", "exports", "modules", "namespaces", "classifiers"
                ):
    ...
    def _from_legacy(self):
        ...
        result = {
            "metadata_version": self.METADATA_VERSION, "generator": self.GENERATOR
        }
        ...
        result["keywords"] = kw
        keys = (
            ("requires_dist", "run_requires"), ("setup_requires_dist", "build_requires")
        )
        for ok, nk in keys:
