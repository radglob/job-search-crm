...
class LinuxDistribution(object):
    ...
    def __repr__(self):
        ...
        """
        return "LinuxDistribution(" "os_release_file={0!r}, " "distro_release_file={1!r}, " "_os_release_info={2!r}, " "_lsb_release_info={3!r}, " "_distro_release_info={4!r})".format(
    ...
    def codename(self):
        ...
        """
        return self.os_release_attr("codename") or self.lsb_release_attr(
            "codename"
        ) or self.distro_release_attr(
            "codename"
        ) or ""
