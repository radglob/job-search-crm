...
class HTMLParser(object):
    ...
    def isHTMLIntegrationPoint(self, element):
        if (
            ...
            return (
                "encoding" in element.attributes
                and element.attributes["encoding"].translate(asciiUpper2Lower) in (
                    ...
                    if (
                        ...
                        or (
                            ...
                            and (
                                (
                                    type == StartTagToken
                                    and token["name"] not in frozenset(
                                        ["mglyph", "malignmark"]
                                    )
                                )
                        ...
                        or (
                            ...
                            and type in (
                                StartTagToken, CharactersToken, SpaceCharactersToken
                            )
                        )
                    ):
                        phase = self.phase
...
def getPhases(debug):
    ...
    class InBodyPhase(Phase):
        ...
        def processCharacters(self, token):
            ...
            if (
                ...
                and any([char not in spaceCharacters for char in token["data"]])
            ):
                self.parser.framesetOK = False
        ...
        def startTagListItem(self, token):
            ...
            for node in reversed(self.tree.openElements):
                ...
                if (
                    node.nameTuple in specialElements
    ...
    class InCellPhase(Phase):
        ...
        def startTagTableOther(self, token):
            if (
                self.tree.elementInScope("td", variant="table")
