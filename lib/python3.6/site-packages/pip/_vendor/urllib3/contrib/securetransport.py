...
from ._securetransport.low_level import (
    _assert_no_error, _cert_array_from_pem, _temporary_keychain, _load_client_cert_chain
)
...
class WrappedSocket(object):
    ...
    def recv_into(self, buffer, nbytes=None):
        ...
        if (result == SecurityConst.errSSLWouldBlock):
            ...
            SecurityConst.errSSLClosedGraceful, SecurityConst.errSSLClosedNoNotify
        ):
