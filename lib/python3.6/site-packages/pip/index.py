...
from pip.utils import (
    cached_property, splitext, normalize_path, ARCHIVE_EXTENSIONS, SUPPORTED_EXTENSIONS
)
...
class PackageFinder(object):
        ...
        for secure_origin in (SECURE_ORIGINS + self.secure_origins):
            ...
            try:
                ...
                network = ipaddress.ip_network(
                    secure_origin[1] if isinstance(
                        secure_origin[1], six.text_type
                    ) else secure_origin[
                        1
                    ].decode(
                        "utf8"
    ...
    def find_all_candidates(self, project_name):
        ...
        return (
            file_versions + find_links_versions + page_versions + dependency_versions
        )
