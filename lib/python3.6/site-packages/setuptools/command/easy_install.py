...
from distutils.errors import (
    DistutilsArgError, DistutilsOptionError, DistutilsError, DistutilsPlatformError
)
...
class WindowsExecutableLauncherWriter(WindowsScriptWriter):
    ...
    def _get_script_args(cls, type_, name, header, script_text):
        ...
        yield (
            name + ".exe", get_win_launcher(launcher_type), "b"  # write in binary mode
        )
