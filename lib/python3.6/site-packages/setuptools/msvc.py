...
class PlatformInfo:
    ...
    def current_dir(self, hidex86=False, x64=False):
        ...
        """
        return (
            "" if (self.current_cpu == "x86" and hidex86) else r"\x64" if (
                self.current_cpu == "amd64" and x64
            ) else r"\%s"
            % self.current_cpu
        )
    ...
    def target_dir(self, hidex86=False, x64=False):
        ...
        """
        return (
            "" if (self.target_cpu == "x86" and hidex86) else r"\x64" if (
                self.target_cpu == "amd64" and x64
            ) else r"\%s"
            % self.target_cpu
        )
    ...
    def cross_dir(self, forcex86=False):
        ...
        return (
            "" if self.target_cpu
            == current else self.target_dir().replace("\\", "\\%s_" % current)
        )
