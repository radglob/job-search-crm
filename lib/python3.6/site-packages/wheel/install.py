...
class WheelFile(object):
    ...
    def __init__(self, filename, fp=None, append=False, context=get_supported):
        """
    ...
    def _sort_key(self):
        return (
            self.parsed_filename.group("name"),
    ...
    def verify(self, zipfile=None):
        ...
        if sig:
            ...
            if payload["hash"] != "sha256=" + native(record_digest):
                ...
                raise BadWheelFile(msg.format(payload["hash"], native(record_digest)))
    ...
    def open(self, name_or_info, mode="r", pwd=None):
        ...
        if name in self._expected_hashes and self._expected_hashes[name] is not None:
            ...
            try:
                ...
                warnings.warn(
                    "Need ZipExtFile._update_crc to implement "
