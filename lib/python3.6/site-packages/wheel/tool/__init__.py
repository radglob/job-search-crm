...
def warn_signatures():
    print(
        "WARNING: The wheel signing and signature verification commands have been deprecated "
        "and will be removed before the v1.0.0 release.",
        file=sys.stderr,
    )
...
def sign(wheelfile, replace=False, get_keyring=get_keyring):
    ...
    keypair = ed25519ll.Keypair(
        urlsafe_b64decode(binary(vk)), urlsafe_b64decode(binary(sk))
    )
        ...
        if req.endswith(".whl"):
            ...
            if os.path.exists(req):
                ...
                if wf.compatible or force:
                    ...
                    msg = (
                        "{0} is not compatible with this Python. "
...
def parser():
    ...
    install_parser.add_argument(
        "requirements", nargs="*", help="Requirements to install."
    )
    install_parser.add_argument(
        "--force",
        default=False,
    ...
    install_parser.add_argument(
        "--requirements-file",
        "-r",
        help="A file containing requirements to " "install.",
    )
    install_parser.add_argument(
        "--list",
        "-l",
    ...
    install_scripts_parser.add_argument(
        "distributions",
        nargs="*",
